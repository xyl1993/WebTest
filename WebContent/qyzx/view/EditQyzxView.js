Ext.define('qy.view.EditQyzxView', {
	extend : 'Ext.panel.Panel',
	uses : ['bu.util.Util'],
	requires : ['Ext.form.Panel', 'Ext.form.field.Hidden', 'qy.model.QyzxModel'],
	alias : 'widget.editQyzxView',
	title : '取药中心_修改',
	id : 'qy',
	closable : true,
	autoScroll : true,
			...
			items : [{
				...
				items : [{
							...
							items : [{
										...
										emptyText : '未取药',             //默认值
										store : me.qy_Store,
										fieldLabel : bu.util.colorText('是否取药'),
										allowBlank : true
									}]
						}, {
							xtype : 'container',
